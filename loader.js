...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const components = [
    ...
    { id: 'sertifikat-placeholder', file: 'sertifikat.html' },
    { id: 'contact-placeholder', file: 'contact.html' },
    { id: 'modal-placeholder', file: 'modal.html' },
    ...
    fetch(item.file)
      ...
      .catch(error => {
        ...
        document.getElementById(item.id).innerHTML = 
          '<div class="container py-5 text-center text-danger">⚠️ Gagal memuat ' + item.file + '</div>';
        loadedCount++;
        if (loadedCount === totalComponents) {
          initializeAll();
        }
...
// ============================================================
// INITIALIZE ALL FEATURES - Dijalankan setelah semua komponen dimuat
// ============================================================
